...
export default function InventoryDashboardPage() {
    ...
    return (<div className="space-y-4">
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <div className="mt-3 overflow-x-auto">
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              {components.slice(0, 10).map((component) => (<tr key={component.id} className="border-b border-slate-100">
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        {alerts.length === 0 ? (<p className="mt-2 text-sm text-slate-600">No low stock alerts.</p>) : (<ul className="mt-3 space-y-2 text-sm">
            {alerts.slice(0, 10).map((alert) => (<li key={alert.id} className="rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-amber-800">
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <div className="mt-3 overflow-x-auto">
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              {movements.map((movement) => (<tr key={movement.id} className="border-b border-slate-100">
