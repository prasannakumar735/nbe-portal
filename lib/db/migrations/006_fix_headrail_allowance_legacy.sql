-- Migration: align headrail allowance with legacy Excel logic
-- Legacy expected value: 50mm
...
BEGIN
    ...
    IF key_col IS NULL OR value_col IS NULL THEN
        RAISE NOTICE 'Could not detect key/value columns in pvc_calculator_settings; skipping headrail allowance fix.';
        RETURN;
    END IF;
    ...
    USING 'headrail_allowance_mm', '50';
END $$;
